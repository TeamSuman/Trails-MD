...
This is the single source of truth for which adaptive CV methods Trails-MD
...
_INSTALL_HINTS = {
    "mlcolvar": 'pip install "trails-md[deep-tica]"  # installs mlcolvar + lightning',
    "lightning": 'pip install "trails-md[deep-tica]"',
