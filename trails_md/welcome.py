"""Terminal run banner for Trails-MD CLI runs."""
...
_LOGO_RAW = r"""
{c1} ______          _ __        __  ________{rst}
{c2}/_  __/_________ (_) /____   /  |/  / __ \{rst}
{c3} / / / ___/ __ `/ / / ___/  / /|_/ / / / /{rst}
{c4}/ / / /  / /_/ / / (__  )  / /  / / /_/ /{rst}
{c5}/_/ /_/   \__,_/_/_/____/  /_/  /_/_____/{rst}
...
def print_run_banner(
    ...
    *,
    ...
    """Print and return a formatted Trails-MD run summary."""
...
def format_run_banner(
    ...
    *,
    ...
    lines.append(
        ...
        + colors.GREEN
        + colors.BOLD
        + "Trails-MD adaptive molecular sampling run".center(width)
        + colors.END
    )
    lines.append("")
...
def _amber_format_summary(format_name: str, executable: str) -> str:
    try:
        from trails_md.engines.amber import (
